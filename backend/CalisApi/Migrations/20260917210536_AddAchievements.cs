...
namespace CalisApi.Migrations
{
    ...
    public partial class AddAchievements : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAchievements_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAchievements_SessionId_AchievementId",
                table: "SessionAchievements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAchievements_UserId_AchievementId_SessionId",
                table: "UserAchievements",
                columns: new[] { "UserId", "AchievementId", "SessionId" },
                unique: true,
